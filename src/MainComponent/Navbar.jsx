...
import "../index.css"
import logo from "../assets/logo/blockailogo.png"
...
>
          ...
          <ul className="navcar flex  flex-row flex-col md:flex-row   overflow-x-hidden  p-4 md:py-1.5 mt-4 font-medium  font-montserrat  md:rounded-[50px] rounded-lg md:space-x-[3vmax] md:flex-row md:mt-0 md:border-0 text-[#ffffff] hover:text-white font-semibold ">
            <li className="relative  group">
              <Link smooth to="/#home" onClick={closeMenu}>
                <div className="font-normal block py-2 px-3 text-[#ffffff] hover:text-[#ffffff] hover:text-white font-semibold hover:bg-gray-700  md:hover:bg-transparent md:p-0 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 font-outfit">
                  Home
                </div>
            ...
            <li className="relative  group">
              <Link smooth to="/#features" onClick={closeMenu}>
                <div className="font-normal block py-2 px-3 text-[#ffffff] hover:text-white font-semibold hover:bg-gray-700 md:hover:bg-transparent md:p-0 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 font-outfit">
                  Features
                </div>
            ...
            <li className="relative  group">
              <Link smooth to="/#mission" onClick={closeMenu}>
                <div className="font-normal block py-2 px-3 text-[#ffffff] hover:text-white font-semibold hover:bg-gray-700 md:hover:bg-transparent md:p-0 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 font-outfit">
                  Mission
                </div>
